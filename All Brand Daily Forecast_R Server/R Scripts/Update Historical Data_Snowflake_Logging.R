...
try({
    ...
    #---- Get the latest date in the historical_data table - CHANGE MADE IN HERE
    ...
    new_data_statement <- paste0("Select Case When brand in ('People', 'Entertainment Weekly', 'People En Espanol') Then 'Entertainment' 
                                 ...
                                 When brand in ('Parenting', 'More (DC)', 'Wood Magazine', 'All People Quilt', 'Living the Country Life', 'Money Magazine') then 'Other'
                                 End As vertical
                                 ...
                                 When brand = 'Money Magazine' Then 'Money Magazine'
                                 End As brand
                                 ...
                                 , 'Parenting', 'More (DC)', 'Wood Magazine', 'All People Quilt', 'Living the Country Life', 'Money Magazine'                                  
                                 )      
    ...
    #---- Upsert new data to the historical data table - CHANGE MADE IN HERE
