...
# Remove the messy data from 9/11 to 9/30 in 2017 (no interpolation)
train <- train.raw
train[train$ds > as.Date('2017-09-11') & train$ds < as.Date('2017-10-01'), 'y'] = NA
...
fit.prophet <- prophet(train
                       ...
                       , changepoints = c('2015-05-29', '2015-07-07', '2017-11-01')
                      )
